  ...
  async function fetchUpdatedTasks() {
    ...
    {assigned.length!=0?
                ...
                return(
                    ...
                    <div>
                        ...
                        <div className="grid grid-flow-col justify-stretch pt-5 w-full gap-3">
                            ...
                            <Update onUpdateTasks={fetchUpdatedTasks} style="rounded bg-[rgba(62,56,245,0.9)]  hover:bg-[hsl(242,80%,65%)] text-white font-medium w-44 py-2"id={task.id} status_details={task.status_details} current_status={task.current_status}/>
                        </div>
                    </div>
                </div>
            )})}
        ...
        <div className="text-center">
            ...
            <p className=" text-stone-400 text-sm -my-10 ">No tasks assigned for you at the moment</p>
        </div>
       }
   </>
  );
